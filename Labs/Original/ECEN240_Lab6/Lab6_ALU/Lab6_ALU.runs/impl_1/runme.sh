...
HD_PWD='C:/Users/Randall_Jack/Desktop/Lab6_ALU/Lab6_ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab6_ALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab6_ALU.tcl -notrace
